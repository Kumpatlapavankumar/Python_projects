...
class QuizApp:
    def __init__(self, root):
        ...
        self.questions = self.load_questions("E:\questions.json")
        ...
        self.question_label = tk.Label(root, text="", font=("Arial", 16), bg="lightblue", fg="black")
        self.question_label.pack(pady=20)

        self.option_buttons = []
        for i in range(4):
            option_button = tk.Radiobutton(root, text="", variable=self.selected_option, value=str(i + 1), font=("Arial", 14), bg="lightblue", fg="black")
            self.option_buttons.append(option_button)
            option_button.pack(pady=10)

        self.next_button = tk.Button(root, text="Next", command=self.check_answer, font=("Arial", 14), bg="lightblue", fg="red")
        self.next_button.pack(pady=10)

        self.finish_button = tk.Button(root, text="Finish Test", command=self.finish_test, font=("Arial", 14), bg="red", fg="white")
        self.finish_button.pack(pady=10)

        self.score_label = tk.Label(root, text="", font=("Arial", 16), bg="lightblue", fg="black")
        self.score_label.pack(pady=20)

        self.timer_label = tk.Label(root, text="", font=("Arial", 14), bg="lightblue", fg="black")
    ...
    def submit_quiz(self):
        ...
        self.next_button.config(state="disabled", bg="lightgray")
        self.finish_button.config(state="disabled", bg="lightgray")
    ...
    def restart_quiz(self):
        ...
        self.score = 0
        self.wrong_answers = []
        self.next_button.config(state="active", bg="lightblue", fg="red")
        self.finish_button.config(state="active", bg="red", fg="white")
    ...
    def update_timer(self):
        if self.timer > 0:
            ...
            next_button_color = "red" if self.timer > 10 else "black"
